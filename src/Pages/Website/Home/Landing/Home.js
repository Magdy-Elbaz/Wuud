...
export default function Home() {
  ...
  return (
    <div dir={i18n.language === "en" ? "ltr" : "rtl"} className="overflow-hidden">
      <Landing />
      <Featuries />
      <LatestSaleProduct iconEye={true} />
      <Offers />
      <Container>
        <div className="d-flex align-items-start gap-5 overflow-hidden gap-lg-0 flex-wrap my-5">
          <ShowTopRated />
          <LatestProducties />
        </div>
      </Container>
      <div className="img-con my-5 overflow-hidden position-relative d-flex align-items-center justify-content-center">
